...
const AddMovie = ({ location }) => {
  ...
  const addNewMovie = () => {
    if (title === '' || description === '' || genre === '' || runTime === '' || showTime === '' || releaseDate === '' || director === '' || cast === '' || price === '') {
  ...
  return (
    <div>
      <Button variant="success" onClick={handleShow}>Add New Movie</Button>
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <Form>
            ...
            <Button variant="success" onClick={addNewMovie}>Add Movie</Button>
          </Form>
        </Modal.Body>
      </Modal>
    </div>
